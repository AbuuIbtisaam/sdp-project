...
class Registration(models.Model):
    ...
    contact = models.CharField(blank=False, unique=True, max_length=10)
...
class Department(models.Model):
    ...
    location_choices = (
        ("C-Block", "Computer Block"),
        ("M-Block", "Mechanical Block"),
        ("R&D Block", "R&D Block"),
    )
    dept_location = models.CharField(
        max_length=50, blank=False, choices=location_choices
    )
